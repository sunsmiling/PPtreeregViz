#' insurance data
#'
#' The \code{insurance} dataset is a preprocessed \code{insurance.csv} dataset which comes as
#' a part of "Medical Cost Personal Datasets" at Kaggle.
#'
#' It contains 1338 rows and 7 variables. These are:
#'
#' \itemize{
...
#' \item smoker - Smoking
#' \item region - the beneficiary's residential area in the US, northeast, southeast, southwest, northwest. charges: Individual medical costs billed by health insurance
#' }
#'
#'
...
#' @name insurance
#'
#' @source The \code{insurance.csv} dataset was downloaded from the Kaggle site.
